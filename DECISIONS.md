...
- 判断の対象は **Advance** である
- 判断の主体は **常に人間**である
- 判断は **Mission / Advance / Workspace** に照らして行われる
- 判断の履歴は **次の前進を拘束する情報**として保存される

---

## 1. 判断の三層モデル（Approve / Reject）
...
#### Workspace Reject
以下の場合、Workspace レベルで Reject される。
...
## 4. Mission Constraint の自動提案と確定の線引き
...
- 判断の種別  
  （Mission Reject / Advance Reject / Workspace Reject / Mission Rework / Constraint）
- 判断理由
- 次の Advance に引き継ぐ制約
